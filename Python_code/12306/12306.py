...
def getTrainList():
    req = urllib2.Request("https://kyfw.12306.cn/otn/leftTicket/query?leftTicketDTO.train_date=2017-12-16&leftTicketDTO.from_station=EHQ&leftTicketDTO.to_station=CSQ&purpose_codes=ADULT")
